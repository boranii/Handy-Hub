              ...
              Column(
                children: [
                  Row(
                    ...
                    children: [
                      StatesText(states: '2025/10/24', statesTitle: 'تاريخ التنفيذ'),
                    ],
                  ),
                  SizedBox(height: AppDimensions.size24),
                  ElevatedButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('صاحب العمل', style: AppTextStyles.title24TextStyle),
              SizedBox(height: AppDimensions.size24),
              Row(
              ...
              SizedBox(height: AppDimensions.size32),
              Text('صور للعمل', style: AppTextStyles.title24TextStyle),
              SizedBox(height: AppDimensions.size24),
              SizedBox(
                height: 100,
                child: Padding(
              ...
              SizedBox(height: AppDimensions.size32),
              Text('نبذة عن العمل', style: AppTextStyles.title24TextStyle),
              SizedBox(height: AppDimensions.size24),
              Padding(
